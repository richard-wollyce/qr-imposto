...
function WebRouter() {
  return getCurrentPath() === PRIVACY_POLICY_PATH ? <PrivacyPolicyPage /> : <LandingPage />;
}
      ...
      >
        <View style={styles.hero}>
          ...
          <View style={styles.actions}>
            ...
            <Pressable accessibilityRole="link" style={styles.secondaryButton} onPress={openPrivacy}>
    ...
    <View style={styles.screen}>
      ...
      >
        <View style={styles.policyHeader}>
          ...
          <Text style={styles.policyUpdated}>Ultima atualizacao: 22/04/2026.</Text>
        </View>
        ...
        <Pressable accessibilityRole="link" style={styles.secondaryButton} onPress={openHome}>
          <ExternalLink color="#111111" size={20} strokeWidth={2.4} />
