...
const PERIOD_LABELS: Record<
	SharePeriodKey,
	{ eyebrow: string; text: string; slug: string }
> = {
...
export function buildScanShareCardPayload(
...
export function buildSummaryShareCardPayload(
	...
	const purchasePhrase = isSingleNote
		? "na minha compra"
		: "nas minhas compras";
...
export function buildShareCardFileName(
	...
	const datePart = Number.isFinite(now.getTime())
