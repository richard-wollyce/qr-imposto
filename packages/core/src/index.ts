...
export function computeTax(
	...
	if (
		typeof invoice.approximateTaxAmount !== "number" ||
		invoice.approximateTaxAmount < 0
	) {
		return {
			ok: false,
			reason: "missing_tax",
			message:
				"Não foi possível encontrar o valor de tributos aproximados desta NFC-e.",
		};
	}
...
export function buildDisplayInsight(
	computation: TaxComputation,
): DisplayInsight {
